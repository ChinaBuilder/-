...
<div class="wrapper">
	...
	<header class="main-header"> <!-- Logo --> <a
		href="/static/index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>名仕</b>医院</span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg">焦作市名仕肿瘤医院</span>
	</a> <!-- Header Navbar: style can be found in header.less --> <nav
		class="navbar navbar-static-top"> <!-- Sidebar toggle button-->
	<a href="#" class="sidebar-toggle" data-toggle="offcanvas"
		role="button"> <span class="sr-only">66666666666666</span> <span
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown user user-menu"><a href="#"
				class="dropdown-toggle" data-toggle="dropdown"> <img
					...
					alt="User Image"> <span class="hidden-xs"><security:authentication
	...
	<ul class="sidebar-menu">
		<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i>
				<span>功能1</span> <span class="pull-right-container"> <i
					class="fa fa-angle-left pull-right"></i>
			</span>
		</a>
			<ul class="treeview-menu">
				<li><a href="/static/index.html"><i class="fa fa-circle-o"></i>
						功能1.1</a></li>
				<li><a href="/static/index2.html"><i class="fa fa-circle-o"></i>
						功能1.2</a></li>
			</ul></li>
		<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
				<span>你的邮件</span> <span class="pull-right-container"> <span
		...
		<li class="treeview active"><a href="#"> <i
			...
			<ul class="treeview-menu">
				...
				<li><a href="pace.html"><i class="fa fa-circle-o"></i> Pace
						Page</a></li>
			</ul></li>
		...
		<li><a href="/static/documentation/index.html"><i
